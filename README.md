...
---
## Funcionalidades
- Cadastro de registros com validação em duas camadas (JS e PHP)
- Exibição do histórico de submissões na mesma página
- Edição de registros existentes diretamente no histórico
- Atualização do histórico sem recarregar a página
- Armazenamento seguro com hash de senha e criptografia de mensagem
...
> **Nota:** Existem outros softwares que cumprem a mesma função. Para o servidor local, este projeto utiliza o **XAMPP** — uma alternativa comum é o **Laragon**. Para a interface de gerenciamento do banco de dados, foi utilizado o **MySQL Workbench** — outra opção popular é o **DBeaver**.
---
## Instalação
**1. Copie o projeto**
```
